export default function Footer() {
  return (
    <footer className="mt-auto border-t border-slate-900/10 bg-white/30 px-8 py-5 text-center text-xs text-slate-500">
      <p>
        AskFin is an unofficial, non-commercial fan project and is not affiliated with, endorsed by,
        or sponsored by Acute Owl Studio.
      </p>
      <p className="mt-1">
