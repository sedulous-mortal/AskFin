"""
Find Quest IDs for "Donate 45 Specimens" and "Donate 60 Specimens" by scanning
MonoBehaviours in resources.assets for their display title text.
"""
import UnityPy
import struct
import json
...
TARGET_TEXTS = [b"Donate 45 Specimens", b"Donate 60 Specimens"]
...
print("Scanning resources.assets for Donate 45/60 Specimens quests...\n")
...
for obj in env.objects:
    ...
    for target in TARGET_TEXTS:
        ...
        if m_name:
            ...
            print(f"\n  displayTitle: '{dt_text}' (len={dt_len})")

            # Search for reward data
            for off in range(0x80, min(0x300, len(raw)-16), 4):
